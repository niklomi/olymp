setSEO = function(title, description, url = 'http://techfights.com/', image = "http://techfights.com/images/mockup.png"){
  if (!title){
    title = "Tech Fights — Best IT Companies and Startups to Work for";
  }
  if (!description){
    description = "Ranking of the best tech companies and top startups based on average salary, employees rating, reviews and more..";
  }
